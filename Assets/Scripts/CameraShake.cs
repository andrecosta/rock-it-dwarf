...
public class CameraShake : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _originalOrthographicSize = _cam.orthographicSize;
    ...
    IEnumerator Shake()
    {
        ...
        while (shakeDuration > 0.01f)
        {
            ...
            else
            {
                ...
                //_cam.orthographicSize = _originalOrthographicSize - rotationAmount.x*0.2f;
            }
        ...
        _cam.orthographicSize = _originalOrthographicSize;
        isRunning = false;
    }
}
